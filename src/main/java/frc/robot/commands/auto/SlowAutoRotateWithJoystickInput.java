 ...
 * @category SWERVE
 */
public class SlowAutoRotateWithJoystickInput extends CommandBase {
  ...
  private double rotationP = 0.0065; 
   ...
   */
  public SlowAutoRotateWithJoystickInput(SwerveDrivetrain swerveDrivetrain, double endAngleDegree, OperatorAngleAdjustment operatorAngleAdjustment, Pigeon pigeon) {

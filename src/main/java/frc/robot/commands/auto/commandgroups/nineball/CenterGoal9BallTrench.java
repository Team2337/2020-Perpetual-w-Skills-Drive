...
public class CenterGoal9BallTrench extends SequentialCommandGroup {
   ...
   */
  public CenterGoal9BallTrench(double delay, Intake intake, OperatorAngleAdjustment operatorAngleAdjustment, Agitator agitator, Serializer serializer, Shooter shooter, KickerWheel kickerWheel, SwerveDrivetrain swerveDrivetrain, Pigeon pigeon, Vision vision) {

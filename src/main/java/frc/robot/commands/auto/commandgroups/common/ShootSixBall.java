 ...
 * Starts the shooter and when when the velocity of the shooter is reached run feed shooter until 6 balls have been shot then turn off the shooter command group
 */
  public ShootSixBall(Intake intake, OperatorAngleAdjustment operatorAngleAdjustment, Agitator agitator, Serializer serializer, Shooter shooter, KickerWheel kickerWheel) {
    ...
    addCommands(
     ...
     new FeedShooter(6, m_operatorAngleAdjustment, m_intake, m_agitator, m_serializer).withTimeout(7),

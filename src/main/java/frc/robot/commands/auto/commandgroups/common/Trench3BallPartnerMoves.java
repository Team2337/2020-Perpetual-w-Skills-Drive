...
public class Trench3BallPartnerMoves extends SequentialCommandGroup {
   ...
   */
  public Trench3BallPartnerMoves(Intake intake, OperatorAngleAdjustment operatorAngleAdjustment, Agitator agitator, Serializer serializer, Shooter shooter, KickerWheel kickerWheel, SwerveDrivetrain swerveDrivetrain, Pigeon pigeon, Vision vision) {
    ...
    addCommands(
      ...
      new PostTrench3Ball(m_intake, m_operatorAngleAdjustment, m_agitator, m_serializer, m_shooter, m_kickerWheel, m_swerveDrivetrain, m_pigeon, m_vision)
    );
  }
}

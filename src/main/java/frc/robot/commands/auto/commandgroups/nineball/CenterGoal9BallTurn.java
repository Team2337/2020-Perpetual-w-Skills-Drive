...
public class CenterGoal9BallTurn extends SequentialCommandGroup {
  ...
  private final Vision m_vision;
     ...
     */
    public CenterGoal9BallTurn(double delay, Intake intake, OperatorAngleAdjustment operatorAngleAdjustment, Agitator agitator, Serializer serializer, Shooter shooter, KickerWheel kickerWheel, SwerveDrivetrain swerveDrivetrain, Pigeon pigeon, Vision vision) {

...
public class CenterGoalBack6BallGenerator2Ball extends SequentialCommandGroup {
   ...
   */
  public CenterGoalBack6BallGenerator2Ball(double delay, Intake intake, OperatorAngleAdjustment operatorAngleAdjustment, Agitator agitator, Serializer serializer, Shooter shooter, KickerWheel kickerWheel, SwerveDrivetrain swerveDrivetrain, Pigeon pigeon, Vision vision) {

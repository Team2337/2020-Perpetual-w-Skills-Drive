 ...
 * @category SWERVE
 */
public class slowStrafeRight extends CommandBase {
   ...
   * @see SwerveDriveCommand
   */
  public slowStrafeRight(SwerveDrivetrain swerveDrivetrain, OperatorAngleAdjustment operatorAngleAdjustment, Pigeon pigeon) {
  ...
  @Override
  public void execute() {
    swerveDrivetrain.calculateJoystickInput(0, -0.2, 0, true);
    i++;
  }
